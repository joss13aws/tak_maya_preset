...
### Characterization ipi Skeleton ###
nameSpace = 'iPiMocap:'
charName = 'ipi_skel'
mel.eval('hikCreateCharacter( "%s" );' %charName)
mel.eval('setCharacterObject("%sHips","%s",1,0);' %(nameSpace, charName))
mel.eval('setCharacterObject("%sSpine","%s",8,0);' %(nameSpace, charName))
mel.eval('setCharacterObject("%sSpine1","%s",23,0);' %(nameSpace, charName))
mel.eval('setCharacterObject("%sSpine2","%s",24,0);' %(nameSpace, charName))
mel.eval('setCharacterObject("%sNeck","%s",20,0);' %(nameSpace, charName))
mel.eval('setCharacterObject("%sHead","%s",15,0);' %(nameSpace, charName))
mel.eval('setCharacterObject("%sLeftShoulder","%s",18,0);' %(nameSpace, charName))
mel.eval('setCharacterObject("%sRightShoulder","%s",19,0);' %(nameSpace, charName))
mel.eval('setCharacterObject("%sLeftArm","%s",9,0);' %(nameSpace, charName))
mel.eval('setCharacterObject("%sRightArm","%s",12,0);' %(nameSpace, charName))
mel.eval('setCharacterObject("%sLeftForeArm","%s",10,0);' %(nameSpace, charName))
mel.eval('setCharacterObject("%sRightForeArm","%s",13,0);' %(nameSpace, charName))
mel.eval('setCharacterObject("%sLeftHand","%s",11,0);' %(nameSpace, charName))
mel.eval('setCharacterObject("%sRightHand","%s",14,0);' %(nameSpace, charName))
mel.eval('setCharacterObject("%sLeftUpLeg","%s",2,0);' %(nameSpace, charName))
mel.eval('setCharacterObject("%sRightUpLeg","%s",5,0);' %(nameSpace, charName))
mel.eval('setCharacterObject("%sLeftLeg","%s",3,0);' %(nameSpace, charName))
mel.eval('setCharacterObject("%sRightLeg","%s",6,0);' %(nameSpace, charName))
mel.eval('setCharacterObject("%sLeftFoot","%s",4,0);' %(nameSpace, charName))
mel.eval('setCharacterObject("%sRightFoot","%s",7,0);' %(nameSpace, charName))
mel.eval('setCharacterObject("%sLeftToeBase","%s",16,0);' %(nameSpace, charName))
mel.eval('setCharacterObject("%sRightToeBase","%s",17,0);' %(nameSpace, charName))
...
### Set T-Pose A52 Rig ###
namespace = 'b1Cha_tomo001:'
cmds.setAttr('%sFKShoulder_L.rx' %namespace, -1.735)
cmds.setAttr('%sFKShoulder_L.ry' %namespace, 2.714)
cmds.setAttr('%sFKShoulder_L.rz' %namespace, 49.173)

cmds.setAttr('%sFKElbow_L.ry' %namespace, -16.383)

cmds.setAttr('%sFKWrist_L.rx' %namespace, 6.74)
cmds.setAttr('%sFKWrist_L.ry' %namespace, -4.169)
cmds.setAttr('%sFKWrist_L.rz' %namespace, 8.398)

cmds.setAttr('%sFKHip_L.ry' %namespace, 3.5)