...
class SplineIKFK(object):
	...
	def ui(cls):
		...
		cls.uiWdgDic['optChkBoxGrp'] = cmds.checkBoxGrp(p = cls.uiWdgDic['mainColLo'], label = 'Build Options: ', numberOfCheckBoxes = 3, labelArray3 = ['FK', 'Stretch', 'Dynamic'], v1 = True, v2 = True)
	...
	def buildSplineIKFK(cls, *args):
		...
		# Clean up outliner
		cls.cleanUpOutliner(cls.crvBndJntLs, cls.bndJntLs, ctrlLs, crv, ikh)
	...
	@classmethod
	def cleanUpOutliner(cls, crvBndJntLs, bndJntLs, ctrlLs, crv, ikh):
		'''
