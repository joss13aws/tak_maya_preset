...
def ui():
	...
	cmds.textField('helperJntSrchTxtFld', text = '_L')
	cmds.textField('helperJntRplcTxtFld', text = '_R')
...
class HelperJoint:
	...
	def createLocGrp(self):
		...
		cmds.parentConstraint(self.prntJnt, helperJntCnstGrp, mo = True)
...
def mirPoseReader(sdkLoc, jntSrch, jntRplc, helperJntSrch, helperJntRplc):
	...
	# print ">>> drvrJntPrnt: " + drvrJntPrnt
	# print ">>> drvrJnt: " + drvrJnt
	# print ">>> drvrJntChld: " + drvrJntChld
	...
	# print ">>> mirDrvrJntPrntName: " + mirDrvrJntPrntName
	# print ">>> mirDrvrJntName: " + mirDrvrJntName
	# print ">>> mirDrvrJntChldName: " + mirDrvrJntChldName
