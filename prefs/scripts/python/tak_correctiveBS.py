...
class Functions(object):
    ...
    def loadGeoBS(cls, *args):
        ...
        # Load BS nodes
        cls.bsList = []
        dfms = tak_lib.getAllDfms(cls.baseGeo)
        if dfms:
    ...
    def removeGarbageOrigShape(cls):
        ...
        for origShape in origShapes:
            connections = cmds.listConnections(origShape)
            if len(connections) == 1 and 'hyperLayout' in connections[0]:
    ...
    def rvrsSkinDfm(cls):
        ...
        for i in xrange(cls.deltaVecArray.length()):
    ...
    def renameUI(cls, *args):
        ...
        cmds.textFieldGrp('newNameTxtFldGrp', label = 'New Name: ', columnWidth = [(1, 60), (2, 200)], text = selTrgList[0], vis = True)
    ...
    def rename(cls, winName, selTrgList, *args):
        ...
        for selTrg in selTrgList:
            ...
            if newName:
                ...
                otherSideName = re.sub(srch, rplc, selTrg)
