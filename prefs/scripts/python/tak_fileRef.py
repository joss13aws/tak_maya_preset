...
# Create logger object to debug and to show information to user
...
class UI(object):
	...
	def loadRef(cls, *args):
		...
		logger.debug('Modified File Contents: \n' + contents.encode('cp949'))
