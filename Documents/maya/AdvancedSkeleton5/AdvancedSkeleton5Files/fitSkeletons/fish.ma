...
//Name: fish.ma
//Last modified: Sat, Sep 03, 2016 12:06:56 PM
//Codeset: 1252
requires maya "2008";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -34.155640816377741 12.060911142380949 11.419442243854879 ;
	setAttr ".r" -type "double3" -17.138352728387773 -74.19999999998825 -1.1681180386865355e-014 ;
...
createNode joint -n "BackF" -p "BackE";
	...
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" -1.9083328088781101e-014 -1.9078088882357255e-014 
		87.186041612433726 ;
	setAttr ".dl" yes;
	setAttr ".typ" 18;
...
createNode joint -n "TailFinUpper" -p "BackF";
	...
	addAttr -ci true -sn "fatZabs" -ln "fatZabs" -at "double";
	setAttr ".ove" yes;
	setAttr ".t" -type "double3" 0.64991292476762474 1.7763568394002505e-015 -4.1981886481139992e-017 ;
	setAttr ".r" -type "double3" -1.0760078161517421e-014 1.2722218725853993e-014 1.2086107789561363e-013 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" 0 -2.404733207644407e-015 -80.447116783526113 ;
...
createNode joint -n "TailFinLower" -p "BackF";
	...
	addAttr -ci true -sn "fatZabs" -ln "fatZabs" -at "double";
	setAttr ".ove" yes;
	setAttr ".t" -type "double3" -0.48307930843301072 0.16142612207718976 -3.3500789855740126e-017 ;
	setAttr ".r" -type "double3" -1.4281228088245341e-014 1.2722218725854053e-014 1.717499527990299e-013 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" 7.4169360959085659e-015 -8.746206263994811e-015 -96.608460778717969 ;
