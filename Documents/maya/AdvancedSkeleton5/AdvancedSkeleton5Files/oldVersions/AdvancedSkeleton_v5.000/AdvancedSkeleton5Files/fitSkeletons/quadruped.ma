...
createNode joint -n "Eye" -p "Head";
	...
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" 179.9999998426139 0.10222629940081296 67.570522454106751 ;
	setAttr ".dl" yes;
	setAttr ".typ" 18;
...
select -ne :defaultResolution;
	...
	setAttr -av -k on ".nds";
	setAttr -k on ".bnm";
	setAttr -av -k on ".w" 320;
	setAttr -av -k on ".h" 240;
