...
//Name: bipedGame.ma
//Last modified: Mon, Aug 29, 2016 03:14:48 PM
//Codeset: 1252
requires maya "2008";
...
createNode joint -n "Hip" -p "Root";
	...
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" 0.57203838694878395 178.21077998921382 2.8717939465701359 ;
	setAttr ".dl" yes;
	setAttr ".typ" 2;
...
createNode joint -n "Spine1" -p "Root";
	...
	addAttr -ci true -sn "fatYabs" -ln "fatYabs" -at "double";
	addAttr -ci true -sn "fatZabs" -ln "fatZabs" -at "double";
	setAttr ".t" -type "double3" 17.561552005093802 3.5527136788005009e-015 -9.4799803786888672e-015 ;
	setAttr -l on ".tz";
...
createNode joint -n "Chest" -p "Spine1";
	...
	addAttr -ci true -sn "fatYabs" -ln "fatYabs" -at "double";
	addAttr -ci true -sn "fatZabs" -ln "fatZabs" -at "double";
	setAttr ".t" -type "double3" 14.259059316898615 3.5527136788005009e-015 -6.5861617938690016e-015 ;
	setAttr -l on ".tz";
...
createNode joint -n "Elbow" -p "Shoulder";
	...
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" -0.0077232552718251293 0.00086387089973085523 6.3821889307179989 ;
	setAttr ".typ" 18;
...
createNode joint -n "ThumbFinger4" -p "ThumbFinger3";
	...
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" -12.991445460162407 6.3611093629270335e-015 -1.2722218725854067e-014 ;
	setAttr ".typ" 18;
